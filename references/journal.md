...
All Vesper journals are Action Journals. Vesper generates and delivers briefings -- these are user-facing outputs.
...
```json
{
  ...
  "action": {
    "side_effect_intent": "briefing_delivery",
